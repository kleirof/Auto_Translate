...
5. Set **RegexForFullTextNeedToTranslation**, **RegexForEachLineNedToTranslate** and **RegexForIgnoreDubstringWithinText**. The default setting is for Chinese. If the target language is Chinese, there is no need to modify it. For other languages, please modify on your own.
6. Select the font you want to override in the **OverrideFont** below.
