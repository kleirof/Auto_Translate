...
9. **RegexForItemTipsModTokenizer**  
...
16. **LogRequestedTexts**  
   在日志中显示请求翻译的文本。

17. **DfTextScaleExpandThreshold**  
   低于这个值的 Df TextScale 会被扩大。为负表示不生效。

18. **DfTextScaleExpandToValue**  
   低于门槛的 Df TextScale 被扩大到多少。

19. **DfDefaultLabelOverrideHeight**  
   Df DefaultLabel 的重写高度值。为零表示不修改。

20. **DfSimpleStatLabelOverrideHeight**  
