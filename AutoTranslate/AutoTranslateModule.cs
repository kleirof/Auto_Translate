...
namespace AutoTranslate
{
    ...
    public class AutoTranslateModule : BaseUnityPlugin
    {
        ...
        private ConfigEntry<float> DfDefaultLabelOverrideHeight;
        private ConfigEntry<float> DfSimpleStatLabelOverrideHeight;
        ...
        private AutoTranslateConfig InitializeConfigs()
        {
            ...
            DfDefaultLabelOverrideHeight = Config.Bind(
                "1.General",
                "DfDefaultLabelOverrideHeight",
                45f,
                "Df DefaultLabel的重写高度值。为零表示不修改。Override height of Df DefaultLabel. Zero means no modification."
                );

            DfSimpleStatLabelOverrideHeight = Config.Bind(
                "1.General",
                "DfSimpleStatLabelOverrideHeight",
                40f,
                "Df SimpleStatLabel的重写高度值。为零表示不修改。Override height of Df SimpleStatLabel. Zero means no modification."
                );
            ...
            AutoTranslateConfig config = new AutoTranslateConfig
            {
                ...
                DfDefaultLabelOverrideHeight = DfDefaultLabelOverrideHeight.Value,
                DfSimpleStatLabelOverrideHeight = DfSimpleStatLabelOverrideHeight.Value,
