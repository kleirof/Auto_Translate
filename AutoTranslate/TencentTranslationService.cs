...
namespace AutoTranslate
{
    ...
    public class TencentTranslationService : ITranslationService
    {
        ...
        public string endpoint = "tmt.tencentcloudapi.com";
        public string action = "TextTranslateBatch"; 
        public string version = "2018-03-21";
        ...
        {
            return inputTexts.Select(text => text.Replace("\r", "")).ToList();
        }
