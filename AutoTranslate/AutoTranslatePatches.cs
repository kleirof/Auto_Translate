...
namespace AutoTranslate
{
    public static class AutoTranslatePatches
    {
        ...
        [HarmonyPatch(typeof(DefaultLabelController), nameof(DefaultLabelController.Trigger), new Type[] { })]
        public class DefaultLabelControllerTriggerPatchClass
        {
            [HarmonyPrefix]
            public static void TriggerPrefix(DefaultLabelController __instance)
            {
                float overrideHeight = config.DfDefaultLabelOverrideHeight;
                if (overrideHeight != 0)
                {
                    __instance.label.AutoSize = false;
                    __instance.panel.Height = overrideHeight;
                    __instance.label.Height = overrideHeight;
                }
            }
        }
        ...
        public class SimpleStatLabelStartPatchClass
        {
            ...
            {
                float overrideHeight = config.DfSimpleStatLabelOverrideHeight;
                if (overrideHeight != 0)
                {
                    __instance.m_label.Height = overrideHeight;
                }
            }
        }
        ...
        public class UpdatePlayerConsumablesPatchClass
        {
            ...
            public static void UpdatePlayerConsumablesPrefix(GameUIRoot __instance)
            {
                ...
                if (overrideHeight != 0)
                {
                    if (__instance.p_playerKeyLabel.Height != overrideHeight)
                        __instance.p_playerKeyLabel.Height = overrideHeight;
                    if (__instance.p_playerCoinLabel.Height != overrideHeight)
                        __instance.p_playerCoinLabel.Height = overrideHeight;
                }
            }
        }
